...
/// "streaming", "image-generation"...). La pantalla las cruza con el precio para
/// poder filtrar por "lo que necesito" antes de comparar cuanto cuesta.
/// </param>
...
/// <summary>
/// Un cambio detectado por el escaneo. <paramref name="ChangeType"/> es "new_model",
/// "provider_new_model", "price_change", "lifecycle_change", "availability_change"
/// o "removed_model".
/// </summary>
...
/// si no, los 72 modelos del catalogo apareceran como "nuevos" el primer dia.
/// </param>
...
/// <summary>Resultado de lanzar el escaneo desde la pantalla: la ejecucion y lo que encontro.</summary>
public record ModelScanResultResponse(
    ModelScanRunResponse Run, List<ModelScanChangeResponse> Changes);

/// <summary>Historico: ultimas ejecuciones del servicio y ultimos cambios detectados.</summary>
