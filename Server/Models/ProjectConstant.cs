...
{
    /// <summary>
    /// Constante declarada a nivel de pipeline (proyecto): por ejemplo "tematica" o
    ...
    /// las constantes de la ejecucion se inyectan como bloque etiquetado en el
    ...
    public class ProjectConstant
    {
        ...
        /// <summary>Para que sirve la constante. Se envia al modelo junto al valor.</summary>
