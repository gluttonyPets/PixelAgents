namespace Server.Models
{
    ...
    public static class ProjectVariableTypes
    {
        ...
        /// <summary>Carpeta de un nodo Directorio de archivos del pipeline. La declaracion
        /// dice de que biblioteca se elige; la carpeta concreta la pone cada ejecucion
        /// (o la planificacion), como cualquier otro valor de variable.</summary>
