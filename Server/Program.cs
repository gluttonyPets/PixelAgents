...
builder.Services.AddTransient<IModuleHandler, VideoEditModuleHandler>();
builder.Services.AddTransient<IModuleHandler, VideoSearchModuleHandler>();
...
builder.Services.AddTransient<GraphPipelineExecutor>();
